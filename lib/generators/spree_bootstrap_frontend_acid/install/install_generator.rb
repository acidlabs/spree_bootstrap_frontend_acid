module SpreeBootstrapFrontendAcid
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_stylesheets
        copy_file 'stylesheets/spree_bootstrap_frontend_acid.css.scss', 'app/assets/stylesheets/store/spree_bootstrap_frontend_acid.css.scss'
